...
## Provided bellow are two (2) functions that are used to create a special object that stores a matrix and caches its 
## inverse.
...
## 2) This function computes the inverse of the special "matrix" created by makeCacheMatrix above. 
